...
export const updateWeather = function (lat, lon) {
    ...
    const currenWeatherSection = document.querySelector("[data-current-weather]");
    const highlightSection = document.querySelector("[data-highlights]");
    const hourlySection = document.querySelector("[data-hourly-forecast]");
    const forecastSection = document.querySelector("[data-5-day-forecast]");

    currenWeatherSection.innerHTML = "";
...
<div class="weapper">
    ...
    <img src="https://openweathermap.org/img/wn/${icon}.png" width="64" height="64" alt="${description}"
        class="weather-icon">
</div>
...
`
        ...
        fetchData(url.reverseGeo(lat, lon), function (locations) {
            if (locations.length > 0) {
                ...
                const region = card.querySelector("[data-location]");
                region.textContent = `${name}, ${country}`;
            }
        });


        currenWeatherSection.appendChild(card);
    ...
    `;
        ...
        <div class="card card-sm slider-card">
                                    ...
                                    <img src="https://openweathermap.org/img/wn/${icon}.png" width="48" height="48" loading="lazy" alt="${description}"
        ...
        <img src="./weathericon/png/direction.png" width="48" height="48" loading="lazy"
            alt="" class="weather-icon" style="transform: rotate(${windDirection - 180}deg)">
        ...
        hourlySection.querySelector("[data-wind]").appendChild(windLi);
            ...
            for (let i = 7, len = forecastList.length; i < len; i += 8) {
                ...
                <img src="https://openweathermap.org/img/wn/${icon}.png" alt="${description}" width="36"
